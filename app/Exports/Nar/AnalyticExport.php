...
class AnalyticExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        foreach($area as $i){
            ...
            $sheet[] = new AnalyticSheet($_data,$i->name);
        }
        return $sheet;
    }
...
//        ");
        ...
        with recursive
        cte_list_date as (
            select CAST('2020-03-01' as DATE) as tanggal
            union all
        ...
        cte_meninggal_harian as (
            ...
            from line_list_nar
            where tanggal_meninggal <> '2000-00-00'
    ...
    select *,
           ...
           total_konfirm_kumulatif / total_test_harian_kumulatif * 100                    as positivity_rate
    from cte_agg;
        ");
    }
}
